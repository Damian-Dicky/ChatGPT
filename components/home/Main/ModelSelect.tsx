...
export default function ModelSelect() {
    ...
    return (
        <div className="flex bg-cyan-200 dark:bg-cyan-900 p-1 rounded-xl">
            {models.map((item) => {
                ...
                return (
                    <button
                        ...
                        className={`hover:text-gray-900 hover:dark:text-gray-100 flex justify-center items-center space-x-2 py-2.5 min-w-[148px] text-sm  font-medium border rounded-lg ${
                            selected
